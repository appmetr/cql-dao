...
public class CqlDao31<T, P1, P2, P3, C1> extends CqlDao4<T, P1, P2, P3, C1> {

    public CqlDao31(MappingManager mappingManager, Class<T> entityClass) {
        super(mappingManager, entityClass);
    }

    public CqlDao31(MappingManager mappingManager, Class<T> entityClass, CallbackExecutorFactory callbackExecutorFactory) {
        super(mappingManager, entityClass, callbackExecutorFactory);
    }

    public CqlDao31(MappingManager mappingManager, Class<T> entityClass, Executor callbackExecutor) {

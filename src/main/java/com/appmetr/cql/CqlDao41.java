...
public class CqlDao41<T, P1, P2, P3, P4, C1> extends CqlDao5<T, P1, P2, P3, P4, C1> {

    public CqlDao41(MappingManager mappingManager, Class<T> entityClass) {
        super(mappingManager, entityClass);
    }

    public CqlDao41(MappingManager mappingManager, Class<T> entityClass, CallbackExecutorFactory callbackExecutorFactory) {
        super(mappingManager, entityClass, callbackExecutorFactory);
    }

    public CqlDao41(MappingManager mappingManager, Class<T> entityClass, Executor callbackExecutor) {

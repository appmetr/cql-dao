...
public class CqlDao21<T, P1, P2, C1> extends CqlDao3<T, P1, P2, C1> {

    public CqlDao21(MappingManager mappingManager, Class<T> entityClass) {
        super(mappingManager, entityClass);
    }

    public CqlDao21(MappingManager mappingManager, Class<T> entityClass, CallbackExecutorFactory callbackExecutorFactory) {
        super(mappingManager, entityClass, callbackExecutorFactory);
    }

    public CqlDao21(MappingManager mappingManager, Class<T> entityClass, Executor callbackExecutor) {
